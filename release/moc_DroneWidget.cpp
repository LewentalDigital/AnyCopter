/****************************************************************************
** Meta object code from reading C++ file 'DroneWidget.h'
**
...
#include <memory>
#include "../view/DroneWidget.h"
#include <QtGui/qtextcursor.h>
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'DroneWidget.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DroneWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_DroneWidget_t qt_meta_stringdata_DroneWidget = {
    {
QT_MOC_LITERAL(0, 11) // "DroneWidget"
...
const QMetaObject DroneWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_DroneWidget.offsetsAndSize,
    qt_meta_data_DroneWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_DroneWidget_t
, QtPrivate::TypeAndForceComplete<DroneWidget, std::true_type>
